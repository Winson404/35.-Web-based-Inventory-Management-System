          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                ...
                <a href="report_product_low_stock.php" class="btn bg-secondary btn-sm float-right mr-2"><i class="fas fa-arrow-left"></i> Back</a>
              </div>
              <div class="card-body">
                 <section id="printElement">
                  ...
                  <p class="title-text"><b>Low Stock Product Records <?= $range ?></b></p>
                  <table>
                    <thead>
                      <tr> 
                        <th>Product ID</th>
