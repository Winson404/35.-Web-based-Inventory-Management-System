                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn bg-warning btn-xs" data-toggle="modal" data-target="#unarchive<?php echo $row['p_Id']; ?>" <?php if($u_type == 'Staff') { echo 'disabled'; } ?>><i class="fas fa-archive"></i> Unarchive</button>
                        </td> 
                    </tr>
