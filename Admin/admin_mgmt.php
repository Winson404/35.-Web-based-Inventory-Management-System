<title>IMS | Administrator info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
              ...
              <div class="card">
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a href="admin.php" class="btn bg-secondary"><i class="fas fa-arrow-left"></i> Back</a>
                    <button type="submit" class="btn bg-primary" name="create_admin" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <form action="../includes/processes.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="float-right">
                  <a href="admin.php" class="btn bg-secondary"><i class="fas fa-arrow-left"></i> Back</a>
                  <button type="submit" class="btn bg-primary" name="update_admin" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </div>
            </div>
          </form>
