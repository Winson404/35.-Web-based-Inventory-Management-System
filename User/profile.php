              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="updateprofile">
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button type="submit" class="btn bg-gradient-primary" id="update_admin" name="user_update_profile_info">Submit</button>
                        </div>
                      </div>
                      </form>
                  ...
                  <div class="tab-pane" id="profileupdate">
                    <form action="../includes/processes.php" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="ml-3">
                       <button type="submit" class="ml-5 btn bg-gradient-primary" name="update_profile_user">Submit</button>
                     </div>
                    </form>
                  </div>
